  ...
  sections: [
    {
      ...
      children: [
        ...
        bullet("Safety gate: binary pass/fail per NPI using NPDB, state boards, and OIG LEIE. PECOS is informational context only. Fail = out of the marketplace entirely"),
        ...
        spacer(),
        para("Business logic:"),
        bullet("query each NPI against NPDB, state medical board records, and the OIG LEIE exclusion list"),
        bullet("if any of those returns an active sanction, unresolved adverse action, or exclusion, the provider fails the gate"),
        bullet("PECOS enrollment is checked as informational context (who bills Medicare) but does not affect pass/fail. Many legitimate independent practices don\u2019t bill Medicare"),
        ...
        bullet("OIG LEIE: federal exclusions from healthcare programs. OIG bulk download. Monthly updates"),
        bullet("PECOS: Medicare enrollment status (informational, not a gate blocker). CMS bulk download. Monthly updates"),
        spacer(),
        ...
        bullet("step 1, safety gate: NPI-level pass/fail from NPDB + OIG LEIE + state boards (PECOS as informational context). Notebook to eng. (Othmane + Antoine)"),
